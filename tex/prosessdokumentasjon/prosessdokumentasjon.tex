...
\begin{figure}[p]
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/a1.png}
                \caption{Fremside -> Sett opp webserver}
                \label{fig:apachehi1}
        \end{subfigure}%
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/a2.png}
                \caption{Valg av mapper}
                \label{fig:apachehi2}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/a3.png}
                \caption{Aktivere visning av innhold i mapper}
                \label{fig:apachehi3}
        \end{subfigure}
        \hspace{0.05cm}
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/a4.png}
                \caption{Valg av moduler}
                \label{fig:apachehi4}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/a5.png}
                \caption{Avanserte Apache moduler}
                \label{fig:apachehi5}
        \end{subfigure}
        \vspace{0.1cm}
        \caption[Hi-fi prototype konfigurasjon av webserver]{Eksempel på konfigurasjon av Apache webserver som fremstiles på en hi-fi prototype}\label{fig:hifiapache}
\end{figure}
...
\begin{figure}[h]
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/b1.png}
                \caption{Fremside -> Velg brukeroppsett}
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/b2.png}
                \caption{Grupper}
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/b3.png}
                \caption{Brukere}
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[width=\textwidth]
                {./img/prosessdokumentasjon/hifi/b4.png}
                \caption{Moduler og resurser for gruppe}
                \label{fig:brukerehi4}
        \end{subfigure}
        \vspace{0.1cm}
        \caption[Konfigurasjon av brukere og grupper i hi-fi prototypr]{Eksempel på konfigurasjon av brukere og grupper i hi-fi prototype}\label{fig:hifibrukere}
\end{figure}
