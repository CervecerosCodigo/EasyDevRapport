...
%\end{center}
\begin{table}[h]
\caption[Sidekart]{En sidekart over det første utkastet. Tabellhode representerer hver enkel menykategori. I rad to presenteres forslag til hver menykategori.}
\label{tab:sidekart}
...
HTML\& PHP		& 	CSS Val		 	& 				& 	MySQL 	& Brukerg \\
